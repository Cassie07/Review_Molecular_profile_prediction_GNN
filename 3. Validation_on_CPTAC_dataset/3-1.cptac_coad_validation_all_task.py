...
if task == 'gene':
    label_path = './top20_coad_cptac.csv'#top20_coad.csv'#./coad_new.csv'
elif task == 'CNA':
    label_path = './top20_coad_cptac_CNA.csv'
else:
    label_path = './top20_coad_cptac_MSI.csv'
dataset_cptac = pd.read_csv(label_path,delimiter=",")
df_cptac = pd.DataFrame(dataset_cptac)
...
if pca_or_not == 'False':
    ...
    adj_path1 = './feature/all_Journal_coad_feature{}_{}_pca_adj_{}_v1.json'.format(feature_dimension, backbone, thred)
    ...
    adj_path2 = './feature/all_Journal_coad_feature{}_{}_pca_adj_{}_v2.json'.format(feature_dimension, backbone, thred)
    ...
    adj_path3 = './feature/all_Journal_coad_feature{}_{}_pca_adj_{}_v3.json'.format(feature_dimension, backbone, thred)
    ...
    adj_path4 = './feature/all_Journal_coad_feature{}_{}_pca_adj_{}_v4.json'.format(feature_dimension, backbone, thred)
    ...
    adj_path5 = './feature/all_Journal_coad_feature{}_{}_pca_adj_{}_v5.json'.format(feature_dimension, backbone, thred)

dic_name_data1, data_name, slide_name_order1, dic_slide_patch1 = generate_dataset(feature_path1, feature_name_path1, adj_path1, use_knn_graph, pca_right_now, 'tcga')
print('[COAD] finish load dataset1')
dic_name_data2, data_name, slide_name_order2, dic_slide_patch2 = generate_dataset(feature_path2, feature_name_path2, adj_path2, use_knn_graph, pca_right_now, 'tcga')
print('[COAD]finish load dataset2')
dic_name_data3, data_name, slide_name_order3, dic_slide_patch3 = generate_dataset(feature_path3, feature_name_path3, adj_path3, use_knn_graph, pca_right_now, 'tcga')
print('[COAD] finish load dataset3')
dic_name_data4, data_name, slide_name_order4, dic_slide_patch4 = generate_dataset(feature_path4, feature_name_path4, adj_path4, use_knn_graph, pca_right_now, 'tcga')
print('[COAD] finish load dataset4')
dic_name_data5, data_name, slide_name_order5, dic_slide_patch5 = generate_dataset(feature_path5, feature_name_path5, adj_path5, use_knn_graph, pca_right_now, 'tcga')
...
###################################################################      Load CPTAC-COAD data    ######################################################################

if pca_or_not == 'False':

    feature_path1 = './feature/all_Journal_cptac_coad_feature{}_{}_v1.json'.format(feature_dimension, backbone)
    feature_name_path1 = './feature/all_Journal_cptac_coad_feature{}_{}_name_v1.json'.format(feature_dimension, backbone)
    adj_path1 = './feature/all_Journal_cptac_coad_feature{}_{}_adj_{}_v1.json'.format(feature_dimension, backbone, thred)

    feature_path2 = './feature/all_Journal_cptac_coad_feature{}_{}_v2.json'.format(feature_dimension, backbone)
    feature_name_path2 = './feature/all_Journal_cptac_coad_feature{}_{}_name_v2.json'.format(feature_dimension, backbone)
    adj_path2 = './feature/all_Journal_cptac_coad_feature{}_{}_adj_{}_v2.json'.format(feature_dimension, backbone, thred)

    feature_path3 = './feature/all_Journal_cptac_coad_feature{}_{}_v3.json'.format(feature_dimension, backbone)
    feature_name_path3 = './feature/all_Journal_cptac_coad_feature{}_{}_name_v3.json'.format(feature_dimension, backbone)
    adj_path3 = './feature/all_Journal_cptac_coad_feature{}_{}_adj_{}_v3.json'.format(feature_dimension, backbone, thred)


    feature_path4 = './feature/all_Journal_cptac_coad_feature{}_{}_v4.json'.format(feature_dimension, backbone)
    feature_name_path4 = './feature/all_Journal_cptac_coad_feature{}_{}_name_v4.json'.format(feature_dimension, backbone)
    adj_path4 = './feature/all_Journal_cptac_coad_feature{}_{}_adj_{}_v4.json'.format(feature_dimension, backbone, thred)

    feature_path5 = './feature/all_Journal_cptac_coad_feature{}_{}_v5.json'.format(feature_dimension, backbone)
    feature_name_path5 = './feature/all_Journal_cptac_coad_feature{}_{}_name_v5.json'.format(feature_dimension, backbone)
    adj_path5 = './feature/all_Journal_cptac_coad_feature{}_{}_adj_{}_v5.json'.format(feature_dimension, backbone, thred)

else:
    feature_path1 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_v1.json'.format(feature_dimension, backbone)
    feature_name_path1 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_name_v1.json'.format(feature_dimension, backbone)
    adj_path1 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_adj_{}_v1.json'.format(feature_dimension, backbone, thred)

    feature_path2 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_v2.json'.format(feature_dimension, backbone)
    feature_name_path2 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_name_v2.json'.format(feature_dimension, backbone)
    adj_path2 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_adj_{}_v2.json'.format(feature_dimension, backbone, thred)

    feature_path3 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_v3.json'.format(feature_dimension, backbone)
    feature_name_path3 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_name_v3.json'.format(feature_dimension, backbone)
    adj_path3 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_adj_{}_v3.json'.format(feature_dimension, backbone, thred)


    feature_path4 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_v4.json'.format(feature_dimension, backbone)
    feature_name_path4 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_name_v4.json'.format(feature_dimension, backbone)
    adj_path4 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_adj_{}_v4.json'.format(feature_dimension, backbone, thred)

    feature_path5 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_v5.json'.format(feature_dimension, backbone)
    feature_name_path5 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_name_v5.json'.format(feature_dimension, backbone)
    adj_path5 = './feature/all_Journal_cptac_coad_feature{}_{}_pca_adj_{}_v5.json'.format(feature_dimension, backbone, thred)

cptac_dic_name_data1, cptac_data_name, cptac_slide_name_order1, cptac_dic_slide_patch1 = generate_dataset(feature_path1, feature_name_path1, adj_path1, use_knn_graph, pca_right_now, 'cptac')
print('[CPTAC] finish load dataset1')
cptac_dic_name_data2, cptac_data_name, cptac_slide_name_order2, cptac_dic_slide_patch2 = generate_dataset(feature_path2, feature_name_path2, adj_path2, use_knn_graph, pca_right_now, 'cptac')
print('[CPTAC] finish load dataset2')
cptac_dic_name_data3, cptac_data_name, cptac_slide_name_order3, cptac_dic_slide_patch3 = generate_dataset(feature_path3, feature_name_path3, adj_path3, use_knn_graph, pca_right_now, 'cptac')
print('[CPTAC] finish load dataset3')
cptac_dic_name_data4, cptac_data_name, cptac_slide_name_order4, cptac_dic_slide_patch4 = generate_dataset(feature_path4, feature_name_path4, adj_path4, use_knn_graph, pca_right_now, 'cptac')
print('[CPTAC] finish load dataset4')
cptac_dic_name_data5, cptac_data_name, cptac_slide_name_order5, cptac_dic_slide_patch5 = generate_dataset(feature_path5, feature_name_path5, adj_path5, use_knn_graph, pca_right_now, 'cptac')
print('[CPTAC] finish load dataset5')
#slide_name_order_list = [slide_name_order1]
#dic_slide_patch_list = [dic_slide_patch1]
cptac_slide_name_order_list = [cptac_slide_name_order1, cptac_slide_name_order2, cptac_slide_name_order3, cptac_slide_name_order4, cptac_slide_name_order5]
cptac_dic_slide_patch_list = [cptac_dic_slide_patch1, cptac_dic_slide_patch2, cptac_dic_slide_patch3, cptac_dic_slide_patch4, cptac_dic_slide_patch5]
...
#label_path = './top20_coadread_CNA.csv'#top20_coadread.csv'#top20_coad.csv'#./coad_new.csv'
#dataset = pd.read_csv(label_path,delimiter=",")
#df = pd.DataFrame(dataset)

for gene in gene_list:

    # load label： tcga-coad
    if task != 'MSI':
        dic_id_label_tcga = {}
        name = df_tcga['id'].values.tolist()
        label = df_tcga[gene].values.tolist()
        false_label_slide = []
        for index,n in enumerate(name,0):
            if label[index] == 2:
                ...
                dic_id_label_tcga[n]=label[index]

    # load label： cptac
    dic_id_label_cptac = {}
    name = df_cptac['id'].values.tolist()
    label = df_cptac[gene].values.tolist()
    false_label_slide = []
    for index,n in enumerate(name,0):
        if label[index] == 2:
            print(label[index])
            ...
            dic_id_label_cptac[n]=label[index]
    #print(false_label_slide)

    # ADD label
    def add_label(dic_name_data, dic_id_label, which_data):
        pos_name_data = []
        neg_name_data = []
        name_neg = []
        name_pos = []
    ...
    name_neg, name_pos, dic_name_data1 = add_label(dic_name_data1, dic_id_label_tcga, 'tcga')
    #print(name_neg)
    #print(name_pos)
    name_neg, name_pos, dic_name_data2 = add_label(dic_name_data2, dic_id_label_tcga, 'tcga')
    name_neg, name_pos, dic_name_data3 = add_label(dic_name_data3, dic_id_label_tcga, 'tcga')
    name_neg, name_pos, dic_name_data4 = add_label(dic_name_data4, dic_id_label_tcga, 'tcga')
    name_neg, name_pos, dic_name_data5 = add_label(dic_name_data5, dic_id_label_tcga, 'tcga')
    ...
    cptac_name_neg, cptac_name_pos, cptac_dic_name_data1 = add_label(cptac_dic_name_data1, dic_id_label_cptac, 'cptac')
    cptac_names = cptac_name_neg + cptac_name_pos

    cptac_name_neg, cptac_name_pos, cptac_dic_name_data2 = add_label(cptac_dic_name_data2, dic_id_label_cptac, 'cptac')
    cptac_name_neg, cptac_name_pos, cptac_dic_name_data3 = add_label(cptac_dic_name_data3, dic_id_label_cptac, 'cptac')
    cptac_name_neg, cptac_name_pos, cptac_dic_name_data4 = add_label(cptac_dic_name_data4, dic_id_label_cptac, 'cptac')
    cptac_name_neg, cptac_name_pos, cptac_dic_name_data5 = add_label(cptac_dic_name_data5, dic_id_label_cptac, 'cptac')

    #cptac_dic_name_data_list = [dic_name_data1]
    cptac_dic_name_data_list = [cptac_dic_name_data1, cptac_dic_name_data2, cptac_dic_name_data3, cptac_dic_name_data4, cptac_dic_name_data5]

    dic_multi_model_pred = {}

    for i in cptac_name_pos:
        dic_multi_model_pred[i] = []

    for i in cptac_name_neg:
        dic_multi_model_pred[i] = []
    ...
    for dic_name_data, slide_name_order, dic_slide_patch in zip(dic_name_data_list, slide_name_order_list, dic_slide_patch_list):
        ...
        #test_dataset = list(cptac_dic_name_data_list[m - 1].values())
        #print(test_dataset[0])
        #print(test_dataset[0].y)


        test_name = cptac_name_neg + cptac_name_pos
        test_dataset = []
        for k, v in cptac_dic_name_data_list[m - 1].items():
            if k in test_name:
        ...
        print('pos/neg in test : {}'.format(len(cptac_name_pos)/len(cptac_name_neg)))
        print()
        ...
        for epoch in range(num_epochs):
            ...
            test_loss, test_acc, pred_label, pred_score, epoch_label, epoch_slide_select_patch = test(test_loader, cptac_slide_name_order_list[m-1], cptac_dic_slide_patch_list[m-1], dataset_name = 'testing')
...
#        flag = pred_list[0]
    ...
    with open('./cptac_coad/result/{}_validation/{}_pca{}_no_drop_10fold_lr1e-3_log.json'.format(task, gene,pca_feature_dimension), 'w') as outfile:
      json.dump(log, outfile)

    with open('./cptac_coad/result/{}_validation/{}_pca{}_no_drop_10fold_lr1e-3_top20_selected_patch.json'.format(task, gene,pca_feature_dimension), 'w') as outfile:
